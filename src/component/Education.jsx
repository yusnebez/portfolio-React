...
export const Education = () => {
  return (
    ...
    <div className='grid grid-cols-2 grid-rows-2 lg:grid-rows-5 lg:h-[500px] xl:w-[1200px] lg:mb-32 rounded-sm gap-4  '>
      ...
      <div className='lg:mt-20 md:ml-20 pt-8 lg:h-[200px] md:w-[730px] h-[400px] xl:w-[1420px] lg:w-[980px] -mt-28 w-screen  rounded-sm row-start-2  bg-[#232323] lg:row-start-2 col-span-2 landscape:h-[250px] landscape:-mt-8 md:portrait:h-[250px] md:portrait:-mt-8'>
