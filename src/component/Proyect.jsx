  ...
  return (
    ...
    >
      ...
      <div className='grid gap-4 lg: lg:grid-cols-1 xl:grid-cols-2'>
          <div className='grid col-start-1 lg:ml-4 p-4 text-white bg-[#232323] rounded-lg lg:h-[300px] md:w-[680px] xl:w-[600px] lg:w-[970px] md:ml-20'>
            <p className='mt-6'>
          ...
          <div className='xl:grid lg:col-start-2 bg-amber-200 hidden xl:h-[300px] rounded-lg xl:w-[600] col-span-3'>
          </div>
        </div>
        <div className='grid row-start-2 gap-4 lg:grid-cols-2'>
          <div className='grid col-start-1 lg:ml-4 p-4 text-white bg-[#232323] rounded-lg lg:h-[300px] lg:w-[970px] xl:w-[600px] md:w-[680px] md:ml-20'>
            <p className='mt-6'>
              2.Página web para gestión de villas, se listan las villas y se actualizan las 
              mismas. Se utiliza para el Front Reactjs con Context Api y Tailwind. Para el Back 
              NodeJs con MongoDB de base de datos.
          ...
          <div className='xl:grid lg:col-start-2 bg-amber-200 xl:h-[300px] hidden rounded-lg xl:w-[600] col-span-3'>
          </div>
        </div>
